	...
	<body>
		...
		<div style="border:2px solid black; background-color:gray;width:98%;margin:0 auto;padding:10px;text-align:center;height:auto"><h1>Book Search</h1>
			...
			<?php
				...
				{
					$sk=$_POST['search'];
					$sql="select * from book_accession where accession_no like '%$sk%'"; 	 
				}
				else
				{
			...
			<form  action="Book_Search.php" method="POST">
			  <input type="text" name="search" placeholder="Search By Id"; value="<?php echo $sk; ?>"> <button>Search</button><br><br> 
			</form>
