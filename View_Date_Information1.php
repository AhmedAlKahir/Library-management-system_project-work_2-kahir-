...
<html>
	...
	<body>
		...
		<form style="width:80%;height:90%;float:center;">
		  ...
		  <button><a href="View_Date_Information1.php">Search</a></button><br><br/>
		  
		  Issue Date:11/10/2019<br><br/>
		  Expairy Date:11/11/2019<br><br/>
		  <button><a href="">Calculate Fine</a></button>
